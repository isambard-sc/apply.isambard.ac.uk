...
THIS SERVICE IS ONLY OPEN TO UNIVERSITY OF BRISTOL STAFF
...
The environment is open to a small number of Schools. You can apply for an account if your School has access and you meet the eligibility criteria to be Project Lead for a research project account (see above).   
...
**NB**: You must attach the following documents when submitting your application:
...
![Screenshot showing MyAccessID login option](images/idp_chooser.png){ style="width:100%;max-width:600px;height:auto"}

Type "bristol" in the box, and choose "University of Bristol" as the identity provider.

![Screenshot showing University of Bristol option](images/myaccessid.png){ style="width:100%;max-width:600px;height:auto"}

Log in using your University of Bristol credentials.

Next, go to the [Calls for Proposals][call-page] page.

![Screenshot showing Calls for Proposals page](images/waldur.png){ style="width:100%;max-width:600px;height:auto"}
...
Please contact the [HPC Allocation and Compliance Committee][hacc-email] if you have any questions about this process.
...
[hacc-email]: mailto:hacc-committee@bristol.ac.uk
